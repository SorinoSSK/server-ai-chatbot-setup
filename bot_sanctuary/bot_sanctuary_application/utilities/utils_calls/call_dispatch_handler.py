...
#
# Notes       :
#   - Entry point is always "chat" - every hop is expressed as one {"target_call", "prompt"} item on dispatch_queue.
...
def message_dissect(dispatch_queue: "queue.Queue", target_call: str, result: dict | str) -> dict | None:
    ...
    Notes:
        ...
        - Invalid JSON is logged at WARNING with its raw text, for diagnosis.
    """
