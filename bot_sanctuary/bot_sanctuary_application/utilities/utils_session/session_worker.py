...
#   - Each SessionWorker gets a fresh, randomly-named session_dir generation, so a future session-resume feature never reuses a stale working directory.
#   - No conversation history is written to session_dir today - clear_session_directory() removes it entirely on session_cleared.
