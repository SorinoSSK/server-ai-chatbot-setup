...
def _handle_text(chat_id: int, message: str, buttons: list[list[dict]] | None = None) -> None:
    """
    ...
    if rows:
        send_message_with_buttons(chat_id, message, rows)
    else:
    ...
    if not task_id:
        ...
        if not mapping:
            ...
            if message_type == "poll":
                ...
                _handle_text(chat_id, data.get("text"), data.get("buttons"))
